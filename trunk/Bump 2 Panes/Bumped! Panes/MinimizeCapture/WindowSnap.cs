...
namespace MinimizeCapture
{
    ...
    class WindowSnap
    {
        ...
        private const string APPLICATION = "Bumped Panes";
        ...
        #region Update for 10 October 2007
        ...
        private static bool EnumWindowsCallback(IntPtr hWnd, IntPtr lParam)
        {
            ...
            if (GetWindowText(hWnd) == START) return true;

            if (GetWindowText(hWnd) == APPLICATION) return true;

            if (GetWindowText(hWnd) == "") return true;
        ...
        private static Image GetWindowImage(IntPtr hWnd, Size size)
        {
            //WindowToFile wtf = new WindowToFile();
            //return wtf.CaptureWindow(hWnd);
            try
            {
        ...
        private WindowSnap(IntPtr hWnd, bool specialCapturing)
        {
            ...
            this.thumbnail = GetWindowImage(hWnd, this.size);
